...
#--------------------------INIT---------------------------#
###########################################################
def wyscout_init(logger):
    #################################################
    #-------------------Init logger-----------------#
    #################################################
    log_starting_process(logger, "Starting properties initiation")

    try:
      #################################################
      #--------------Configuration file---------------#
      #################################################
      init_properties(logger)
      
      log_finished_process(logger, "Properties initiation completed")
...
def wyscout_areas(logger):
    ...
    try:
      ...
      #-----------------Areas request-----------------#
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','areas', initial_time)
...
def wyscout_areas_competitions(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','competitions_areas', initial_time)
...
def wyscout_competitions_details(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','competitions_details', initial_time)
...
def wyscout_competitions_players(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','competitions_players', initial_time)
...
def wyscout_competitions_teams(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','competitions_teams', initial_time)
...
def wyscout_competitions_matches(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','competitions_matches', initial_time)
...
def wyscout_competitions_seasons(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','competitions_seasons', initial_time)
...
def wyscout_seasons_details(logger):
    ...
    try:
      ...
      #################################################
      list_seasons = get_all_seasons_id(config_file, list_competitions, logger)

      #################################################
      #----------------Seasons request----------------#
      #################################################
      initial_time = get_time(logger)   
      set_raw_initial_watermark_value('wyscout','seasons_details', initial_time)   
...
def wyscout_seasons_players(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)  
      set_raw_initial_watermark_value('wyscout','seasons_players', initial_time)    
...
def wyscout_seasons_teams(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)      
      set_raw_initial_watermark_value('wyscout','seasons_teams', initial_time)
...
def wyscout_seasons_transfers(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)  
      set_raw_initial_watermark_value('wyscout','seasons_transfers', initial_time)
      set_raw_watermark_value('wyscout','last_update_transfers', initial_time)    
...
def wyscout_seasons_assistmen(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)    
      set_raw_initial_watermark_value('wyscout','seasons_assistmen', initial_time)  
...
def wyscout_seasons_career(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)   
      set_raw_initial_watermark_value('wyscout','seasons_careers', initial_time)   
...
def wyscout_seasons_fixtures(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)     
      set_raw_initial_watermark_value('wyscout','seasons_fixtures', initial_time) 
...
def wyscout_seasons_matches(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)    
      set_raw_initial_watermark_value('wyscout','seasons_matches', initial_time)  
...
def wyscout_seasons_scorers(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)      
      set_raw_initial_watermark_value('wyscout','seasons_scorers', initial_time)
...
def wyscout_seasons_standings(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)    
      set_raw_initial_watermark_value('wyscout','seasons_standings', initial_time)  
...
def wyscout_players_details(logger):
    ...
    try:
      ...
      #################################################
      #----Get list of different ID of the season-----#
      #################################################
      list_players = get_all_players_id(config_file, list_seasons, logger)

      #################################################
      #----------------Players request----------------#
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','players_details', initial_time)
...
def wyscout_players_transfers(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','players_transfers', initial_time)
...
def wyscout_players_matches(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','players_matches', initial_time)
...
def wyscout_players_career(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','players_career', initial_time)
...
def wyscout_players_contract_info(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','players_contract_info', initial_time)
...
def wyscout_players_fixtures(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','players_fixtures', initial_time)
...
def wyscout_players_advanced_stats(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','players_advanced_stats', initial_time)
...
def wyscout_players_matches_advanced_stats(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','players_matches_advanced_stats', initial_time)
...
def wyscout_matches_details(logger):
    ...
    try:
      ...
      #----Get list of different ID of the season-----#
      #################################################
      list_matches = get_all_matches_id(config_file, list_seasons, logger)

      #################################################
      #----------------Matches request----------------#
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','matches_details', initial_time)
...
def wyscout_matches_formations(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','matches_formations', initial_time)
...
def wyscout_matches_directions(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','matches_directions', initial_time)
...
def wyscout_matches_fulltracking(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','matches_fulltracking', initial_time)
...
def wyscout_matches_events(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','matches_events', initial_time)
...
def wyscout_matches_advanced_stats(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','matches_advanced_stats', initial_time)
...
def wyscout_matches_player_advanced_stats(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','matches_player_advanced_stats', initial_time)
...
def wyscout_teams_details(logger):
    ...
    try:
      ...
      #----Get list of different ID of the season-----#
      #################################################
      list_teams = get_all_teams_id(config_file, list_seasons, logger)

      #################################################
      #-----------------Teams request-----------------#
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','teams_details', initial_time)
...
def wyscout_teams_transfers(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','teams_transfers', initial_time)
...
def wyscout_teams_career(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','teams_career', initial_time)
...
def wyscout_teams_fixtures(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','teams_fixtures', initial_time)
...
def wyscout_teams_matches(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','teams_matches', initial_time)
...
def wyscout_teams_squad(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','teams_squad', initial_time)
...
def wyscout_teams_advanced_stats(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','teams_advanced_stats', initial_time)
...
def wyscout_teams_matches_advanced_stats(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','teams_matches_advanced_stats', initial_time)
...
def wyscout_videos_details(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','videos_details', initial_time)
...
def wyscout_videos_qualities(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','videos_qualities', initial_time)
...
def wyscout_videos_offsets(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','videos_offsets', initial_time)
...
def wyscout_rounds(logger):
    ...
    try:
      ...
      #################################################
      list_rounds = get_all_rounds_id(config_file, list_seasons, logger)

      #################################################
      #----------------rounds request-----------------#
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','rounds', initial_time)
...
def wyscout_referees(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','referees', initial_time)
...
def wyscout_coaches(logger):
    ...
    try:
      ...
      #################################################
      initial_time = get_time(logger)
      set_raw_initial_watermark_value('wyscout','coaches', initial_time)
